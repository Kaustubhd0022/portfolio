...
export const Hero = () => {
  return (
    <FloatingIconsHero
      ...
      subtitle="Specializing in 0-to-1 products, multi-agent AI pipelines, and high-impact consumer experiences."
    ...
    >
      <motion.div 
        ...
        className="w-full mt-10 relative z-20 pointer-events-auto max-w-2xl mx-auto"
      >
        <AskAI />
      </motion.div>
    </FloatingIconsHero>
